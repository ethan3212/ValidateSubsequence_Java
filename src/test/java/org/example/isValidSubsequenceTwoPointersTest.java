...
class isValidSubsequenceTwoPointersTest {
    @Test
    void test1() {
        var array = Arrays.asList(5, 1, 22, 25, 6, -1, 8, 10);
        var sequence = Arrays.asList(1, 6, -1, 10);
        assertTrue(Main.isValidSubsequenceTwoPointers(array, sequence));
    }
    ...
    void test10() {
        ...
        assertFalse(Main.isValidSubsequenceTwoPointers(array, sequence));
    }
